...
latest verified remote implementation SHA:
                 e5e405e0659548f16f725082d23543adc8c95755
latest paired CI: push 33901119145 / PR 33901125467
```
...
- 实现活动连接 Fencing/Kick 与生产 KMS/HSM Signer Adapter；
...
- M2 的生产 Signer、持久 Connection Generation/Fencing、ABA Enrollment/Connector 与完整 HEC 生命周期；
